...
/** @type {string} */
const CACHE_VERSION = '1772667194|428607809';
/** @type {string} */
const CACHE_PREFIX = 'Tabletop_RPG-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Tabletop_RPG.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Tabletop_RPG.html","Tabletop_RPG.js","Tabletop_RPG.offline.html","Tabletop_RPG.icon.png","Tabletop_RPG.apple-touch-icon.png","Tabletop_RPG.audio.worklet.js","Tabletop_RPG.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Tabletop_RPG.wasm","Tabletop_RPG.pck"];
